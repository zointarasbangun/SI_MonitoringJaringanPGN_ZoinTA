        ...
        <div class="card" style="background:#1265A8" padding:10px;">
            <div class="content-header">
                ...
                <section class="content">
                    <div class="container-fluid">
                        <form method="POST" action="{{ route('teknisi.updatelog', ['id' => $log->id]) }} " enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="card-body text-light">
                                <div class="mb-2 ">
                                    ...
                                    <input type="text" name="teknisi" id="defaultForm-username"
                                        class="form-control validate" placeholder="Input nama" value="{{ $namaTeknisi }}"
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="custom-select form-control validate" id="user_id" name="user_id"
                                        ...
                                        @foreach ($user as $s)
                                            <option value="{{ $s->id }}"
                                                {{ $s->id == $log->user_id ? 'selected' : '' }}>{{ $s->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
